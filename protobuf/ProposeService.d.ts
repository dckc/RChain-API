        ...
        namespace casper {
            ...
            namespace protocol {
                ...
                class ProposeService extends $protobuf.rpc.Service {
                    ...
                    public propose(request: coop.rchain.casper.protocol.IPrintUnmatchedSendsQuery, callback: coop.rchain.casper.protocol.ProposeService.proposeCallback): void;
                    public propose(request: coop.rchain.casper.protocol.IPrintUnmatchedSendsQuery): Promise<Either>;
                }

                namespace ProposeService {

                    type proposeCallback = (error: (Error|null), response?: Either) => void;
                }
                ...
                class PrintUnmatchedSendsQuery implements IPrintUnmatchedSendsQuery {
                    constructor(properties?: coop.rchain.casper.protocol.IPrintUnmatchedSendsQuery);
                    public printUnmatchedSends: boolean;
                    public static create(properties?: coop.rchain.casper.protocol.IPrintUnmatchedSendsQuery): coop.rchain.casper.protocol.PrintUnmatchedSendsQuery;
                    public static encode(message: coop.rchain.casper.protocol.IPrintUnmatchedSendsQuery, writer?: $protobuf.Writer): $protobuf.Writer;
                    public static encodeDelimited(message: coop.rchain.casper.protocol.IPrintUnmatchedSendsQuery, writer?: $protobuf.Writer): $protobuf.Writer;
                    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): coop.rchain.casper.protocol.PrintUnmatchedSendsQuery;
                    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): coop.rchain.casper.protocol.PrintUnmatchedSendsQuery;
                    public static verify(message: { [k: string]: any }): (string|null);
                    public static fromObject(object: { [k: string]: any }): coop.rchain.casper.protocol.PrintUnmatchedSendsQuery;
                    public static toObject(message: coop.rchain.casper.protocol.PrintUnmatchedSendsQuery, options?: $protobuf.IConversionOptions): { [k: string]: any };
